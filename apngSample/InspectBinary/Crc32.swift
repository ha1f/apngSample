// https://gist.github.com/MaddTheSane/b43d467ad4c5c2e305b5
...
final class CRC32 {
     ...
     */
    static func crc32(_ crc: UInt32, buffer: UnsafePointer<UInt8>, length: Int) -> UInt32 {
        var buf = buffer
        ...
        func DO1() {
            ...
            buf = buf.successor()
            crc1 = CRC32.crcTable[Int((crc1 ^ UInt32(toBuf)) & 0xFF)] ^ crc1 >> 8
        }
        func DO2() { DO1(); DO1(); }
        func DO4() { DO2(); DO2(); }
        func DO8() { DO4(); DO4(); }
...
extension Data {
    func calcCrc32(crc: UInt32 = 0) -> UInt32 {
        return self.withUnsafeBytes { bytes in
            return CRC32.crc32(crc, buffer: bytes, length: self.count)
        }
    }
}
